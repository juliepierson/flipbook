...
from .flipbook_algorithm import FlipbookAlgorithm


class FlipbookProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(FlipbookAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('Raster animation')
